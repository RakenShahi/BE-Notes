...
public class QuestionsAdapter extends RecyclerView.Adapter<QuestionsAdapter.ViewHolder> {
    ...
    public QuestionsAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {//to create views for recycler view items
        View view= LayoutInflater.from(context).inflate(R.layout.questions_item,parent,false);
